...
# 🛡️ OpenThreat — design notes

**Why each module works the way it does.**

[**README**](../README.md) is the short version: what the project is, how to run it, what it
publishes. This is the long one — the reasoning behind each design decision and the bugs that
produced it. It is the former README, kept because the reasoning is the part that is expensive
to reconstruct.
